      ...
      <>
        ...
        <PageContent>
          <Container>
            ...
            <p>Para realizar o envio de mensagens pelo MailShrimp, você precisa possuir um domínio associado a sua conta.</p>
            <p>Você precisa atualizar seus DNS, adicionandoas novas entradas a seguir e adicionar um e-mail para ser o remetente de envio.</p>
            ...
            <h5>SPF</h5>
            <p>Crie ou atualize a entrada SPF no seu DNS. Para configuração do MX, adicione a prioridade informada:</p>
            <Table bordered striped hover>
              <thead>
                <tr>
                  <th>Tipo</th>
...
function RenderLines({ records }) {
  return (
    <>
    {records.dnsRecords.length === 0 && <RenderEmptyRow message='Nenhum DNS disponível para configuração.' />}
    {records.verified ? 
      <RenderVerifiedRow /> : 
